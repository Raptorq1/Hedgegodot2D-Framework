...
export(int, "None", "Round", "Floor", "Ceiling", "Truncate") var grid_alignment = ACTIONS.Align.NONE
...
func _enter_tree():
	...
	add_to_group(ACTIONS.UUID_TILE_SPAWNER)

func _exit_tree():
	remove_from_group(ACTIONS.UUID_TILE_SPAWNER)
